  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center  my-10">
        <h1 className="text-4xl font-bold pb-4 ">Subscribe Our Newsletter</h1>
      ...
      <div className="flex items-center justify-center gap-2 w-full">
        <input
          type="search"
          id="default-search"
          className="block  w-80 py-2 outline-none ps-4 text-base  text-gray-900 border border-gray-300 rounded-sm bg-gray-50 focus:ring-blue-500 focus:border-gray-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
